...
import FormikYupForm from "@/components/Mobile/FormikYupForm";
import FormikZodForm from "@/components/Mobile/FormikZodForm";
import ReactHookForm from "@/components/Mobile/ReactHookForm";
import ReactFinalForm from "@/components/Mobile/ReactFinalForm";
...
function MobileHomepageLayout() {
  ...
  return (
    <div>
          ...
          <div className="flex mb-[12px]">
            {menuData.map((item, index) => (
              <button
                ...
                } border-b-[2px] px-[5px] py-[10px] text-base not-italic leading-[22px] transition-all text-[12px]`}
      ...
      <div className="flex items-center justify-center relative z-10 px-3">
